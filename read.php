...
try{
  ...
  //orderパラメータの値が存在すれば（並び変えボタンを押したとき）、その値を変数$orderに代入する 
  if(isset($_GET['order'])){
    $order = $_GET['order'];
  }else{
    $order = NULL;
...
<html lang="ja">
  <head>
       ...
       <div class="products-ui">
         <div>
          <a href="read.php?order=desc&keyword=<?= $keyword ?>">
            <img src="images/desc.png" alt="降順に並び変え" class="sort-img">
         </a> 
         <a href="read.php?order=asc&keyword=<?= $keyword ?>">
            <img src="images/asc.php" alt="昇順に並び変え"class="sort-img">
         </a>
   ...
   <footer>
     <p class="copyringht">&copy; 商品管理アプリ ALL rights reserved.</p>
   </footer>
 </body>